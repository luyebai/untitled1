...
public interface Graph {
    public static final int UNDIRECTEDGRAPH=0;//表示无向图
    public static final int DIRECTEDGRAPH=1;//表示有向图
    //返回图的类型
    public int getType();
    //返回图中的顶点数vex是vertex的缩写
    ...
    public boolean areAdiacent(Vertex u,Vertex v);
    //返回从u指向v的边，不存在则返回null
    public Edge edgeFromTo(Vertex u,Vertex v);
    //返回从u出发可以直接到达的邻接顶点  adj是adjoin的缩写
